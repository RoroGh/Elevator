...
entity finalelevator_tb2 is
end finalelevator_tb2;

architecture behavior of finalelevator_tb2 is
...
begin
  ...
  begin
     ...
     lvl2in <= '1'; wait for 30 ms;
     lvl2in <= '0'; wait for 3000 ms;
     lvl0in  <= '1'; wait for 30 ms;
     lvl0in <= '0'; lvl1out <= '1'; wait for 30 ms;
     lvl1out <= '0'; wait;
  end process;
